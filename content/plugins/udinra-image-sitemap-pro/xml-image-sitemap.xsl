...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		<title>XML Image Sitemap Pro</title>
	...
	<body>
		<div id="content">
			<h1>XML Image Sitemap Pro</h1>
			<p class="expl">
				Generated by <a href="https://udinra.com/">Udinra</a>'s <a href="https://udinra.com/blog/udinra-image-sitemap/">Udinra Image Sitemap Pro plugin</a>, this is an XML Image Sitemap, meant for consumption by Search Engines.
			</p>
			<p class="expl">
			...
			<div id="content">
				...
				<thead>
					<tr>
						...
						<th width="70%"><table width="100%"><tbody><tr><th width="40%"><b>Image location</b></th><th width="30%"><b>Image Caption</b></th><th width="30%"><b>Image Title</b></th></tr></tbody></table></th>
					</tr>
				</thead>
				<tbody>
